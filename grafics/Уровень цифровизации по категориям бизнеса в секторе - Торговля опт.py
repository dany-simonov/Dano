...
merged_df = pd.merge(russia_2019_df, wholesale_trade_types, on='d1a1x', how='inner')
...
plt.title('Уровень цифровизации по категориям бизнеса в секторе "Торговля (опт)"', fontsize=16)
